...
const movies = [
	{
		...
		trailer: 'https://www.youtube.com/embed/EDvJBDXV2tA',
		movie: 'https://www.youtube.com/embed/EDvJBDXV2tA',
		genre_id: 7,
		category_id: 1,
		status: 1,
		created_at: new Date()
	},
	{
		...
		trailer: 'https://www.youtube.com/embed/4mwtDHovB3w',
		movie: 'https://www.youtube.com/embed/4mwtDHovB3w',
		genre_id: 1,
		category_id: 2,
		status: 1,
		created_at: new Date()
	},
	{
		...
		trailer: 'https://www.youtube.com/embed/8ZZ1l7QCVGE',
		movie: 'https://www.youtube.com/embed/8ZZ1l7QCVGE',
		genre_id: 12,
		category_id: 5,
		status: 1,
		created_at: new Date()
	},
	{
		...
		length: 106,
		image: 'cars-2.jpg',
		trailer: 'https://www.youtube.com/embed/PiMXLiNINJ8',
		movie: 'https://www.youtube.com/embed/PiMXLiNINJ8',
		genre_id: 15,
		category_id: 1,
		status: 1,
		created_at: new Date()
	},
	{
		...
		movie: 'https://www.youtube.com/embed/mb79ctR-E-c',
		genre_id: 15,
		category_id: 1,
		status: 1,
		created_at: new Date()
	},
	{
		...
		movie: 'https://www.youtube.com/embed/f33yJZ5uOpU',
		genre_id: 15,
		category_id: 1,
		status: 1,
		created_at: new Date()
